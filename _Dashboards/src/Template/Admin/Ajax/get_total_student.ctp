						...
						foreach ($sections as $section => $sectionData) {
							if ($sectionData['section_total']) {
								...
								<tr>
									...
									<td><?= (isset($sectionData['religion']['Christian']) ? $sectionData['religion']['Christian'] : '') ?>
									</td>
									...
									<td><?= (isset($sectionData['quota']['freedom_fighter']) ? $sectionData['quota']['freedom_fighter'] : null) ?>
									</td>
