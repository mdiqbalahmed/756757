	...
	public function getTotalStudent()
	{
		...
		foreach ($students as $student) {
			...
			if ($student['group_name'] == 'Science') {
				...
				$studentCounts[$student['level_name']][$student['shift_name']][$student['section_name']]['group']['Arts']++;
			} else if ($student['group_name'] == 'Commerce') {
				$studentCounts[$student['level_name']][$student['shift_name']][$student['section_name']]['group']['Commerce']++;
			}
