                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-9 row2Field position-relative">
                                            <div style="display: none; position: absolute; left: -15px; top: 5px;">
                                                <?= $this->Html->image('/webroot/uploads/indicator.gif', ['style' => 'width: 20px; height: 20px;']) ?>
                                            </div>
                                            <select class="form-control" name="section_id" id="section_id">
                                                <option value=""><?= __d('students', '-- Choose --') ?></option>
                                                <?php foreach ($sections as $section) { ?>
                                                    <option value="<?php echo $section['section_id']; ?>" <?php if ($data['section_id'] == $section['section_id']) echo 'selected'; ?>>
